...
extern void ReadDataFromImageC(unsigned char* imgC, unsigned char* imgR, int Size, int& bitI, int& stringI, vector<bool>& decoded);
...
extern bool DecodeFolder(const string& eFoldername);