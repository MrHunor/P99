...
set "SRC_AUDIO=testfiles\content\sound.wav"
...
set "SINGLE_OUT_AUDIO=testfiles\content\soundM.wav"
...
:: Note: Not aggressively deleting soundM.wav in initial cleanup in case it's a static test asset, but you may add it if it is generated by the EXE.
